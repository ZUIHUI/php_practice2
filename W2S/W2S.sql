...
-- 資料庫: `walktoschool`
--
CREATE DATABASE IF NOT EXISTS `walktoschool` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `walktoschool`;
...
CREATE TABLE `apply_info` (
  `apply_no` int(11) NOT NULL COMMENT '評核編號',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='報名學校基本資料檔';
...
CREATE TABLE `banner_info` (
  `banner_no` int(11) NOT NULL COMMENT '廣告編號',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='廣告基本資料檔';

--
-- 傾印資料表的資料 `banner_info`
--
...
(7, 'ad33', 0, 'sds', '2000-11-23', '2000-12-30', 34, '2022-01-02 19:32:16', NULL, '1');
...
CREATE TABLE `comment_schedule` (
  ...
  `join_date` datetime NOT NULL COMMENT '新增時間',
  `modify_date` datetime DEFAULT NULL COMMENT '修改時間'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='評核行程基本資料檔';

--
-- 傾印資料表的資料 `comment_schedule`
--
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='系統資料表基本資料檔';

--
-- 傾印資料表的資料 `export_info`
--
...
CREATE TABLE `export_log` (
  `export_no` int(11) NOT NULL COMMENT '匯出編號',
  `table_no` int(11) NOT NULL COMMENT '表格編號',
  ...
  `join_date` datetime NOT NULL COMMENT '新增時間'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='匯出資料記錄檔';
...
CREATE TABLE `news_info` (
  `news_no` int(11) NOT NULL COMMENT '消息編號',
  ...
  `join_date` datetime NOT NULL COMMENT '新增時間',
  `modify_date` datetime DEFAULT NULL COMMENT '修改時間'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='最新消息基本資料檔';
...
(9, '2000-11-30', '1', 'ss', 0, 'ttt', 34, '2022-01-02 19:00:31', '2022-01-02 19:09:35');
...
CREATE TABLE `pic_info` (
  ...
  `join_date` datetime NOT NULL COMMENT '新增時間'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='圖片基本資料檔';
...
CREATE TABLE `qa_info` (
  `qa_no` int(11) NOT NULL COMMENT 'Q&A編號',
  ...
  `join_date` datetime NOT NULL COMMENT '新增時間',
  `modify_date` datetime DEFAULT NULL COMMENT '修改時間'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Q&A基本資料檔';
...
CREATE TABLE `qa_parent` (
  `qa_no` int(11) NOT NULL,
  `join_date` datetime NOT NULL,
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='家長環境評估表資料檔';
...
CREATE TABLE `qa_school` (
  ...
  `f517` varchar(400) DEFAULT NULL,
  `f52` int(11) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='學校環境評估表資料檔';
...
CREATE TABLE `seed_info` (
  `seed_no` int(11) NOT NULL COMMENT '活動編號',
  `school_no` varchar(10) NOT NULL COMMENT '學校編號',
  ...
  `join_date` datetime NOT NULL COMMENT '新增時間',
  `modify_date` datetime DEFAULT NULL COMMENT '修改時間'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='種子學校活動資料檔';
...
CREATE TABLE `user_info` (
  `user_no` int(10) UNSIGNED NOT NULL COMMENT '使用者編號',
  `id` varchar(20) NOT NULL COMMENT '帳號',
  `passwd` varbinary(20) NOT NULL COMMENT '密碼',
  ...
  `join_date` datetime NOT NULL COMMENT '新增時間',
  `modify_date` datetime DEFAULT NULL COMMENT '修改時間'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='使用者基本資料檔';
...
(25, 'admin', 0x61646d696e, 'admin', '1', '', '', '', '', '', '2008-08-28 08:40:32', '2012-03-27 08:30:35'),
(27, 'seed', 0x73656564, 'seed', '2', '0116061', '', '', '', '', '2008-08-28 09:38:31', '2012-03-27 08:30:26'),
(28, 'user3', 0x7573657233, 'user3', '3', '', '', '', '', '', '2008-08-29 02:59:00', '2012-03-27 08:30:44'),
(34, 'aaa', 0x8d2d05b10279174291022c88123068f9, 'aaa', '1', '', '', '', '', '', '2022-01-01 16:45:20', NULL);
...
-- 資料表索引 `qa_parent`
--
ALTER TABLE `qa_parent`
  ADD PRIMARY KEY (`qa_no`);

--
-- 資料表索引 `qa_school`
--
ALTER TABLE `qa_school`
  ADD PRIMARY KEY (`qa_no`);

--
-- 資料表索引 `school_area`
--
ALTER TABLE `school_area`
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `apply_info`
--
ALTER TABLE `apply_info`
  MODIFY `apply_no` int(11) NOT NULL AUTO_INCREMENT COMMENT '評核編號', AUTO_INCREMENT=128;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `banner_info`
--
ALTER TABLE `banner_info`
  MODIFY `banner_no` int(11) NOT NULL AUTO_INCREMENT COMMENT '廣告編號', AUTO_INCREMENT=8;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `comment_schedule`
--
ALTER TABLE `comment_schedule`
  MODIFY `schedule_no` int(11) NOT NULL AUTO_INCREMENT COMMENT '行程編號', AUTO_INCREMENT=7;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `export_info`
--
ALTER TABLE `export_info`
  MODIFY `table_no` int(11) NOT NULL AUTO_INCREMENT COMMENT '表格編號', AUTO_INCREMENT=5;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `export_log`
--
ALTER TABLE `export_log`
  MODIFY `export_no` int(11) NOT NULL AUTO_INCREMENT COMMENT '匯出編號', AUTO_INCREMENT=41;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `news_info`
--
ALTER TABLE `news_info`
  MODIFY `news_no` int(11) NOT NULL AUTO_INCREMENT COMMENT '消息編號', AUTO_INCREMENT=11;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `pic_info`
--
ALTER TABLE `pic_info`
  MODIFY `pic_no` int(11) NOT NULL AUTO_INCREMENT COMMENT '圖片編號', AUTO_INCREMENT=94;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `qa_info`
--
ALTER TABLE `qa_info`
  MODIFY `qa_no` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Q&A編號', AUTO_INCREMENT=6;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `qa_parent`
--
ALTER TABLE `qa_parent`
  MODIFY `qa_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `qa_school`
--
ALTER TABLE `qa_school`
  MODIFY `qa_no` int(11) NOT NULL AUTO_INCREMENT;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `seed_info`
--
ALTER TABLE `seed_info`
  MODIFY `seed_no` int(11) NOT NULL AUTO_INCREMENT COMMENT '活動編號', AUTO_INCREMENT=4;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `user_info`
--
ALTER TABLE `user_info`
  MODIFY `user_no` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '使用者編號', AUTO_INCREMENT=35;
COMMIT;
